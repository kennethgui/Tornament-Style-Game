...
/*
    ...
    - experience_points_ : An int representing experience points the quest rewards upon completion
...
public:
    ...
    */
    bool addQuest(const std::string &title, const std::string &description,
    ...
    */
    ...
    /**
        ...
        [Quest Description]\n\n
    */
    void printQuest(const Quest *quest) const;
    ...
    */
    void questQuery(const std::string &quest_title) const;
    ...
    */
    int calculateProjectedExperience(const Quest *main_quest) const;
    ...
    */
    int calculatePathwayExperience(const Quest *main_quest) const;
    ...
    */
    void printQuestDetails(const Quest* main_quest) const;
        ...
        @post: Outputs the subquest pathway, displaying quest names with two spaces ("  ") of indentation for each subquest, printed recursively.
            ...
            [Main Quest] ([Pathway XP] / [Projected XP]% Complete)
                [Subquest0]: [Complete / Not Complete]
                    ...
                    [Subquest02]: [Complete / Not Complete]
    */
    void subquestsRecursive(const Quest *quest, int indentation) const;
};

#endif // QUEST_LIST_HPP_
